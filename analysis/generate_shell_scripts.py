...
# for ix, sample in enumerate(samps):
	...
	o.write("python /home/sosi/SqCL_revisions/calculate_ss_per_species_marker.py --lineage %s --file %s --dir /scratch/drabosky_flux/sosi/brazil/ --outdir /home/sosi/SqCL_revisions/\n" % (lineage, file))
